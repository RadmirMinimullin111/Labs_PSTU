#include "Header.h"
using namespace std;
bool* zon = new bool[maximumVerts]; //курсор в зоне круга
bool per = false; //перемещены ли вершины
bool obj = false; //отвечает за перемещение вершин 
int ver;//перемещаемая вершина
int CursX;//позиция курсора 
int CursY;
